  ...
  return (
    <section className="full-training">
      <div className="container pt-5 text-center">
        <h2
          className="mt-0 pt-0 wow fadeInUp animated animated"
        ...
        >
          {t("Training.Enhancing")}
        </h2>
        <h4
          className="wow fadeInUp animated animated"
        ...
        <p
          className={
            selectFontBig
              ? "fs-26 wow fadeInUp col-sm-10 mrg-lr-auto animated animated"
              : selectFontSmall
              ? "wow fadeInUp col-sm-10 mrg-lr-auto animated animated"
              : "fs-20 wow fadeInUp col-sm-10 mrg-lr-auto animated animated"
          }
      ...
      <div className="container">
        <div className="contentTrain">
              ...
              <a onClick={() => openCourseModal(120)} className="new-hire-a">
                ...
                >
                  ...
                  <span
                    className={
                      selectFontBig
                        ? "fs-26 new-hire-p-span"
                        : selectFontSmall
                        ? "new-hire-p-span"
                        : "fs-20 new-hire-p-span"
                    }
                  >
                    {t("Training.NewHireSpan")}
                  </span>
                </p>
          ...
          <div className="box-middle">
            <a
              href="https://youtu.be/OHCbiPtMgGg"
              target="_blank"
              className={
                selectFontBig
                  ? "fs-26 box-middle-p"
